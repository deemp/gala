...
Projects created with `gala new` include a `.claude/settings.json` that makes Claude Code offer the plugin automatically. Details: [ide/claude-code](ide/claude-code/README.md).
